...
Introduction:
  ...
  In this study, an Australian bike shop owner overcame this dilemma (to maximize their marketing ROI) by using their CRM data on transactions and customers for the past 3 years. Our goals were to identify yearly and monthly sales trends, identify profitable customer segments and bike lines, identify top-selling bike lines and top-purchasing customers, and identify the customer traits associated with higher profits / more frequent purchases. By analyzing the data and looking for trends, this allowed for the creation of a data-driven customer profile and a potential model to help predict new sales for individual customers in real-time.
